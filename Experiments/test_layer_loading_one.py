...
state_a.update(load_file(f"./layers/embed_tokens.safetensors"))
for i in range(stopping_layer):
    state_a.update(load_file(f"./layers/layer_{i}.safetensors"))
    print(f"Loaded layer {i}")

for i in range(stopping_layer, len(model.model.layers)):
    state_a.update(load_file(f"./layers/layer_{i}.safetensors"))
    print(f"Loaded layer {i}")

state_b.update(load_file(f"./layers/head.safetensors"))
