...
Interleaving is demonstrated when multiple machines run main.py
with different session IDs simultaneously — the Scheduler on the
master daemon round-robins between them.
